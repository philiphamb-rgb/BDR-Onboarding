...
const V21: Walkthrough = {
  ...
  steps: [
    ...
    { route: '/analytics', selector: '[data-tour="an-calc"]', emoji: '💰', title: 'Income & Commission Planner',
      body: 'Open the planner and turn your income goal into an exact daily number. It back-solves your calls/demos, projects the year, tracks your weekly pace — and sets the goal that Home, Today, and the Coach all plan around.' },
