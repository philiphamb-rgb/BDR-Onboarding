...
// Growth OS — Overview. The "where you stand" home: shared chrome (health + KPIs
    ...
    <div className="space-y-4 stagger-rise">
      ...
      {loading ? (
        ...
        <>
          ...
          {/* One coach */}
          <button onClick={() => askCoach("Look at my Growth OS: my income, leads-per-week and close-rate goals, my pipeline by temperature, and what my AI Team is doing. What are the 3 highest-leverage moves to grow my number this week?")}
