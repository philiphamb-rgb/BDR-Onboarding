...
const BELT_BG: Record<string, string> = {
  white:'bg-gray-100 border border-gray-300',yellow:'bg-yellow-400',orange:'bg-orange-500',
...
export default function OnboardingPage() {
  ...
  return (
    <div className="w-full max-w-sm">
      ...
      <div className="bg-white rounded-2xl shadow-card-hover p-6 min-h-[420px] flex flex-col">
        ...
        {step === 1 && (
          <div className="flex flex-col flex-1">
            <div className="flex-1">
              <h2 className="text-h2 text-gray-900 mb-1">Your profile</h2>
              <p className="text-sm text-gray-500 mb-5">Tell us who you are.</p>
              <div className="space-y-4">
                <div>
                  <label className="text-label text-gray-700 mb-1 block">Full Name</label>
                ...
                <div>
                  <label className="text-label text-gray-700 mb-1 block">Phone <span className="text-gray-400 font-normal">(optional)</span></label>
        ...
        {step === 2 && (
          <div className="flex flex-col flex-1">
            <div className="flex-1">
              <h2 className="text-h2 text-gray-900 mb-1">Your start date</h2>
              <p className="text-sm text-gray-500 mb-5">When did you join ConsumerDirect?</p>
              ...
              <div className="bg-gray-50 rounded-xl p-4 border border-border">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div>
                    <div className="font-semibold text-gray-900">{currentBelt.label}</div>
                    <div className="text-xs text-gray-500">Day {daysSinceStart}</div>
                  </div>
                </div>
                <p className="text-sm text-gray-600">{currentBelt.desc}</p>
              </div>
            </div>
            <div className="flex gap-3 mt-6">
        ...
        {step === 3 && (
          <div className="flex flex-col flex-1">
            <div className="flex-1">
              <h2 className="text-h2 text-gray-900 mb-1">Daily habits</h2>
              <p className="text-sm text-gray-500 mb-4">You start with 5 default habits. Customize them any time.</p>
