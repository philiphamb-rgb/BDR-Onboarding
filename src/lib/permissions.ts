...
export const FEATURES: Feature[] = [
  ...
  { key: 'time_blocking',label: 'Time Blocking',   group: 'Focus',    scope: 'rep', href: '/schedule' },
  ...
  { key: 'mgr_rhythm',      label: 'Team Time Blocking', group: 'Manager', scope: 'manager', href: '/manager/rhythm' },
