...
export interface AutomationMeta {
  ...
  cardDescription: string        // one plain-English sentence shown on the card face
  ...
  minPerRun: number              // minutes saved each time this runs
  runsPerMo: number               // typical runs per month
  moHoursSaved: number            // minPerRun × runsPerMo, in hours
  dollarValue: number              // moHoursSaved × $50/hr
...
export const AUTOMATION_META: Record<string, AutomationMeta> = {
  scoring: { action: 'Score + Route', hrsWeek: 4,
    cardDescription: 'Gives every new agency lead a score 0–100 the second they come in.',
    ...
    minPerRun: 8, runsPerMo: 60, moHoursSaved: 8, dollarValue: 400,
  ...
  alert: { action: 'SMS + Slack Alert', hrsWeek: 2,
    cardDescription: 'Pings you by text and Slack the moment a lead scores 80+. You\'re never slow again.',
    ...
    minPerRun: 5, runsPerMo: 40, moHoursSaved: 3.3, dollarValue: 167,
  ...
  'call-prep': { action: 'One-page call brief', hrsWeek: 3,
    cardDescription: 'Builds a one-page research summary before every partner call — automatically.',
    ...
    minPerRun: 25, runsPerMo: 12, moHoursSaved: 5, dollarValue: 250,
  ...
  noshow: { action: 'Reschedule SMS', hrsWeek: 2,
    cardDescription: 'Sends a warm rescheduling text the second a partner misses a call.',
    ...
    minPerRun: 10, runsPerMo: 8, moHoursSaved: 1.3, dollarValue: 67,
  ...
  nurture: { action: '5-touch email sequence', hrsWeek: 5,
    cardDescription: 'Runs a 5-email warm follow-up with every new lead — no manual sends needed.',
    ...
    minPerRun: 45, runsPerMo: 20, moHoursSaved: 15, dollarValue: 750,
  ...
  'cold-nurture': { action: '14-day education drip', hrsWeek: 4,
    cardDescription: 'Sends 14 days of education to cold leads until they\'re ready to talk.',
    ...
    minPerRun: 30, runsPerMo: 10, moHoursSaved: 5, dollarValue: 250,
    tools: [{ name: 'HubSpot', connected: true }, { name: 'Claude', connected: true }],
  ...
  affiliate: { action: 'Tag + Co-Brand Path', hrsWeek: 3,
    cardDescription: 'Tags partners and routes them to the right co-branded materials automatically.',
    ...
    minPerRun: 5, runsPerMo: 30, moHoursSaved: 2.5, dollarValue: 125,
  ...
  winback: { action: 'Win-Back Campaign', hrsWeek: 3,
    cardDescription: 'Re-engages partners who went quiet for 30+ days.',
    ...
    minPerRun: 20, runsPerMo: 15, moHoursSaved: 5, dollarValue: 250,
    tools: [{ name: 'HubSpot', connected: true }, { name: 'Claude', connected: true }],
  ...
  'content-idea': { action: 'Daily ranked content queue', hrsWeek: 5,
    cardDescription: 'Every morning: tells you exactly what to post, ranked by expected revenue.',
    why: 'Every morning this drafts and ranks the day\'s content ideas by expected value — so you never stare at a blank screen wondering what to make.',
    impactStat: '−80%', impactLabel: 'less time deciding what to make', source: 'Internal content-ops time estimate',
    minPerRun: 30, runsPerMo: 30, moHoursSaved: 15, dollarValue: 750,
  ...
  'hook-research': { action: 'Fresh hook library', hrsWeek: 2,
    cardDescription: 'Keeps your content opening lines fresh — researches new hooks weekly.',
    ...
    minPerRun: 60, runsPerMo: 4, moHoursSaved: 4, dollarValue: 200,
    tools: [{ name: 'Claude', connected: true }, { name: 'Analytics', connected: true }],
  ...
  referral: { action: 'Welcome + Referral ask', hrsWeek: 2,
    cardDescription: 'Welcomes new partners and asks for a referral at their happiest moment.',
    ...
    minPerRun: 15, runsPerMo: 10, moHoursSaved: 2.5, dollarValue: 125,
    tools: [{ name: 'HubSpot', connected: true }, { name: 'Claude', connected: true }],
  ...
  'customer-retention': { action: 'Churn-risk flag + nudge', hrsWeek: 4,
    cardDescription: 'Flags partners going quiet before they churn — and sends a nudge.',
    ...
    minPerRun: 20, runsPerMo: 8, moHoursSaved: 2.7, dollarValue: 133,
  ...
  testimonial: { action: 'Testimonial ask → content', hrsWeek: 2,
    cardDescription: 'Asks happy partners for a testimonial and feeds it into your content pipeline.',
    ...
    minPerRun: 30, runsPerMo: 5, moHoursSaved: 2.5, dollarValue: 125,
    tools: [{ name: 'HubSpot', connected: true }, { name: 'Claude', connected: true }],
    config: [ { key: 'auto', label: 'Route returns into content queue', type: 'toggle', value: true } ] },

  qa: { action: 'Nightly pipeline audit', hrsWeek: 2,
    cardDescription: 'Every night: checks your pipeline for gaps, stalled deals, and missed follow-ups.',
    ...
    minPerRun: 45, runsPerMo: 30, moHoursSaved: 22.5, dollarValue: 1125,
    tools: [{ name: 'HubSpot', connected: true }, { name: 'Claude', connected: true }],
  ...
  reconciliation: { action: 'Weekly income reconcile', hrsWeek: 2,
    cardDescription: 'Every week: compares commissions owed vs received. Flags any mismatch.',
    ...
    minPerRun: 90, runsPerMo: 4, moHoursSaved: 6, dollarValue: 300,
  ...
  'daily-briefing': { action: 'Morning SMS brief', hrsWeek: 1,
    cardDescription: 'Every morning: one text with the single most important thing to do today.',
    ...
    minPerRun: 10, runsPerMo: 30, moHoursSaved: 5, dollarValue: 250,
