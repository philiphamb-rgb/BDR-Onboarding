...
export const HOME_TOUR: TourStep[] = [
  ...
  { selector: '[data-tour="home-rhythm"]', emoji: '⏱', title: 'Always know your next move', body: 'This card shows your live time block and the single best action. One tap and you’re there.' },
...
export const RHYTHM_TOUR: TourStep[] = [
  { emoji: '⏱', title: 'Engineer your perfect day', body: 'A pro-optimized, calendar-style day built around your selling hours.' },
  { selector: '[data-tour="rhythm-timeline"]', emoji: '', title: 'Drag, resize, tap', body: 'Drag a block to move it, drag its bottom edge to resize, and tap any block for notes, tasks, and a jump-to link.' },
]
...
export const RESOURCES_TOUR: TourStep[] = [
  ...
  { selector: '[data-tour="resources-tools"]', emoji: '', title: 'Jump straight in', body: 'Tap any tool to open it. Your whole stack lives right here.' },
]
