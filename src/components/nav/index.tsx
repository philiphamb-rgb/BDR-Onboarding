...
const GROWTH_SUBNAV: (NavItem & { feature?: string; lock?: boolean })[] = [
  ...
  { href: '/admin/compliance', label: 'Compliance',  icon: ShieldIcon,    feature: 'growth_build', lock: true },
  { href: '/admin/observability', label: 'AI Company', icon: BarChartIcon, feature: 'growth_build', lock: true },
]
...
const PAGE_INDEX: { label: string; href: string }[] = [
  ...
  { label: 'AI Company', href: '/admin/observability' }, { label: 'Observability', href: '/admin/observability' },
  { label: 'Compliance', href: '/admin/compliance' }, { label: 'Approved Language', href: '/admin/compliance' },
