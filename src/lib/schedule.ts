...
export const OPTIMIZED_DAY: ScheduleBlock[] = [
  { off: 0,   dur: 30,  label: 'Review Pipeline & Plan',          type: 'plan',  tip: 'Sort leads by score, set your top 3, clear HubSpot tasks, flag today’s risers.' },
  { off: 30,  dur: 120, label: 'Talk to Partners — Power Block 1', type: 'focus', tip: 'Your highest-energy calling block. No admin — live conversations only.' },
  { off: 150, dur: 15,  label: 'Break',                            type: 'break' },
  { off: 165, dur: 75,  label: 'Talk to Partners — Power Block 2', type: 'focus', tip: 'Demos and discovery. Lead with the prospect’s pain (Sandler).' },
  { off: 240, dur: 30,  label: '30 Min Lunch',                     type: 'lunch' },
  { off: 270, dur: 90,  label: 'Talk to Partners — Follow-ups',    type: 'focus', tip: 'Re-engage risers, send order forms, book the next step before you hang up.' },
  { off: 360, dur: 15,  label: 'Break',                            type: 'break' },
  { off: 375, dur: 105, label: 'Clean Up Records & Onboarding',    type: 'admin', tip: 'CRM hygiene, log every call, advance partner onboarding checklists.' },
  { off: 480, dur: 30,  label: 'End-of-Day Standard',             type: 'plan',  tip: 'Update deal stages, log activity, set tomorrow’s first three calls.' },
]
